...
public partial class SalesHistoryPage : ContentPage
{
    ...
    public SalesHistoryPage(InventoryTransactionService transactions, BusinessService businesses)
    {
        InitializeComponent();
    ...
    protected override async void OnAppearing()
    {
        ...
        try
        {
            ...
            HistoryList.ItemsSource = (await _transactions.GetRecentAsync(_businessId, InventoryDocumentType.Sale, 500))
